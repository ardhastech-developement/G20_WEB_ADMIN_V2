    ...
    [6842], {
        6970: function (t, e, n) {
            ...
            var c = 1e-6,
                ...
                P = Math.ceil,
                j = Math.exp,
                O = (Math.floor, Math.hypot),
                S = Math.log,
                M = (Math.pow, Math.sin),
                x = Math.sign || function (t) {
            ...
            var T, z, R, Y, X = {
                ...
                FeatureCollection: function (t, e) {
                    for (var n = t.features, i = -1, r = n.length; ++i < r;) L(n[i].geometry, e)
                }
            },
                I = {
                    Sphere: function (t, e) {
                    ...
                    MultiLineString: function (t, e) {
                        for (var n = t.coordinates, i = -1, r = n.length; ++i < r;) G(n[i], e, 0)
                    },
                    Polygon: function (t, e) {
                        B(t.coordinates, e)
                    },
                    MultiPolygon: function (t, e) {
                        for (var n = t.coordinates, i = -1, r = n.length; ++i < r;) B(n[i], e)
                    },
                    GeometryCollection: function (t, e) {
                        for (var n = t.geometries, i = -1, r = n.length; ++i < r;) L(n[i], e)
                    }
                };
            ...
            function B(t, e) {
                var n = -1,
                    i = t.length;
                for (e.polygonStart(); ++n < i;) G(t[n], e, 1);
                e.polygonEnd()
            }

            function Z(t, e) {
                t && X.hasOwnProperty(t.type) ? X[t.type](t, e) : L(t, e)
            }
            var A = {
                sphere: k,
                point: k,
            ...
            function V(t, e) {
                ...
                var n = M(e *= y),
                    ...
                    l = Y * n - R * i * o,
                    u = R * n + Y * i * o;
                T.add(_(D(a * a + l * l), u)), z = t, R = n, Y = i
            }

            function J(t) {
                return T = new s, Z(t, A), +T
            }
            var H = [null, null],
                Q = {
                    type: "LineString",
                                ...
                                for (var c = 0; c < s.length; c++) {
                                    ...
                                    if (f.length > 1) {
                                        for (var p = 1; p < f.length; p++)
                                            if (r = i / n, o = (i += q(a = f[p - 1], l = f[p])) / n, r <= t && o > t) {
                                                c = s.length;
                                                break
                                            }
                ...
                tt = function (t) {
                    function e() {
                        ...
                        return Object.defineProperty(e, "mapLines", {
                            ...
                            value: new K.o($.YS.new({}), (function () {
                                return U._new(e._root, {}, [e.mapLines.template])
                            }))
                    ...
                    return (0, i.ZT)(e, t), Object.defineProperty(e.prototype, "makeMapLine", {
                        ...
                        value: function (e) {
                            ...
                            var i = e.get("mapLine");
                            i || (i = this.makeMapLine(e)), e.set("mapLine", i);
                            var r = e.get("pointsToConnect");
                            r && (o.each(r, (function (t) {
                                t.on("geometry", (function () {
                                    n.markDirtyValues(e)
                                })), t.on("longitude", (function () {
                                    n.markDirtyValues(e)
                                })), t.on("latitude", (function () {
                                    n.markDirtyValues(e)
                                }))
                            })), this.markDirtyValues(e)), i.setPrivate("series", this)
                        }
            ...
            var rt = function (t) {
                ...
                return (0, i.ZT)(e, t), Object.defineProperty(e.prototype, "_afterNew", {
                    ...
                    value: function () {
                        var t = function () {
                            var t, e, n, i, r, o, a, l, u, s, f, p, h = 10,
                                g = h,
                                d = 90,
                                v = 360,
                                y = 2.5;
                            ...
                            return m.lines = function () {
                                ...
                                return arguments.length ? (i = +t[0][0], n = +t[1][0], l = +t[0][1], a = +t[1][1], i > n && (t = i, i = n, n = t), l > a && (t = l, l = a, a = t), m.precision(y)) : [
                                    [i, l],
                                    [n, a]
                                ]
                            }, m.extentMinor = function (n) {
                                return arguments.length ? (e = +n[0][0], t = +n[1][0], o = +n[0][1], r = +n[1][1], e > t && (n = e, e = t, t = n), o > r && (n = o, o = r, r = n), m.precision(y)) : [
                                    [e, o],
                                    [t, r]
                                ]
                            }, m.step = function (t) {
                ...
                if (t.forEach((function (t) {
                    ...
                    for (var s, c, f = l[0]; ;) {
                        ...
                        do {
                            if (p.v = p.o.v = !0, p.e) {
                                if (h)
                                    for (o = 0, a = s.length; o < a; ++o) r.point((c = s[o])[0], c[1]);
                                else i(p.x, p.n.x, 1, r);
                                p = p.n
                            } else {
                                if (h)
                                    for (s = p.p.z, o = s.length - 1; o >= 0; --o) r.point((c = s[o])[0], c[1]);
            ...
            function Dt(t, e, n, i) {
                return function (r) {
                            ...
                            polygonEnd: function () {
                                ...
                                var t = function (t, e) {
                                    ...
                                    for (var f = 0, v = t.length; f < v; ++f)
                                        if (b = (y = t[f]).length)
                                            for (var y, b, m = y[b - 1], P = Mt(m), j = m[1] / 2 + g, O = M(j), S = w(j), x = 0; x < b; ++x, P = E, O = k, S = L, m = D) {
                                                var D = y[x],
                                                    E = Mt(D),
                                                    C = D[1] / 2 + g,
                                                    k = M(C),
                                                    ...
                                                    Y = R > p,
                                                    X = O * k;
                                                if (u.add(_(X * z * M(R), S * L + X * w(R))), a += Y ? T + z * d : T, Y ^ P >= n ^ E >= n) {
                                                    var I = Pt(_t(m), _t(D));
                                                    St(I);
                                                    var G = Pt(o, I);
                                                    St(G);
                                                    var B = (Y ^ T >= 0 ? -1 : 1) * N(G[2]);
                                                    (i > B || i === B && (I[0] || I[1])) && (l += Y ^ T >= 0 ? 1 : -1)
                                                }
                                            }
                    ...
                    function D() {
                        ...
                        var t, e, n, i, u = v.clean(),
                            s = f.result(),
                            c = s.length;
                        if (l.pop(), o.push(l), l = null, c)
                            if (1 & u) {
            ...
            var Ct = Dt((function () {
                ...
                var r;
                if (null == t) r = n * h, i.point(-p, r), i.point(0, r), i.point(p, r), i.point(p, 0), i.point(p, -r), i.point(0, -r), i.point(-p, -r), i.point(-p, 0), i.point(-p, r);
                else if (b(t[0] - e[0]) > c) {
                    var o = t[0] < e[0] ? p : -p;
            ...
            function Lt(t, e, n, i, r, o) {
                if (n) {
                    var a = w(e),
                        l = M(e),
                        u = i * n;
                    null == r ? (r = e + i * d, o = e - u / 2) : (r = Tt(a, r), o = Tt(a, o), (i > 0 ? r < o : r > o) && (r += i * d));
                ...
                return Dt(o, (function (t) {
                    ...
                    return {
                        ...
                        point: function (f, h) {
                            var g, d = [f, h],
                                v = o(f, h),
                                y = i ? v ? 0 : l(f, h) : v ? l(f + (f < 0 ? p : -p), h) : 0;
                            if (!e && (s = u = v) && t.lineStart(), v !== u && (!(g = a(e, d)) || dt(e, g) || dt(d, g)) && (d[2] = 1), v !== u) c = 0, v ? (t.lineStart(), g = a(d, e), t.point(g[0], g[1])) : (g = a(e, d), t.point(g[0], g[1], 2), t.lineEnd()), e = g;
                            else if (r && e && i ^ v) {
                                var b;
            ...
            function Xt(t, e, n, i) {
                ...
                function o(r, o, l, s) {
                    var c = 0,
                        f = 0;
                    if (null == r || (c = a(r, l)) !== (f = a(o, l)) || u(r, o) < 0 ^ l > 0)
                        do {
                ...
                return function (a) {
                    var u, s, c, f, p, h, g, d, v, y, b, m = a,
                        ...
                        w = {
                            ...
                            polygonEnd: function () {
                                var e = function () {
                                    for (var e = 0, n = 0, r = s.length; n < r; ++n)
                                        for (var o, a, l = s[n], u = 1, c = l.length, f = l[0], p = f[0], h = f[1]; u < c; ++u) o = p, a = h, p = (f = l[u])[0], h = f[1], a <= i ? h > i && (p - o) * (i - a) > (h - a) * (t - o) && ++e : h <= i && (p - o) * (i - a) < (h - a) * (t - o) && --e;
                                    return e
                                }(),
                                    n = b && e,
                                    r = (u = xt(u)).length;
                    ...
                    function j(o, a) {
                        var l = r(o, a);
                        if (s && c.push([o, a]), y) f = o, p = a, h = l, y = !1, l && (m.lineStart(), m.point(o, a));
                        else if (l && v) m.point(o, a);
                        else {
                    ...
                    function n(i, r, o, a, l, u, s, f, p, h, g, d, v, y) {
                        ...
                        if (P > 4 * e && v--) {
                            var j = a + h,
                                ...
                                M = D(j * j + O * O + S * S),
                                x = N(S /= M),
                                E = b(b(S) - 1) < c || b(o - p) < c ? (o + p) / 2 : _(O, j),
                                C = t(E, x),
                                k = C[0],
                                L = C[1],
                                T = k - i,
                                z = L - r,
                                R = w * T - m * z;
                            (R * R / P > e || b((m * T + w * z) / P - .5) > .3 || a * h + l * g + u * d < $t) && (n(i, r, o, a, l, u, k, L, E, j /= M, O /= M, S, v, y), y.point(k, L), n(k, L, E, j, O, S, s, f, p, h, g, d, v, y))
                        }
                    }
                    return function (e) {
            ...
            function re(t) {
                ...
                function k() {
                    var t = ne(f, 0, 0, P, j, w).apply(null, e(g, d)),
                        i = ne(f, p - t[0], h - t[1], P, j, w);
                    return n = ct(b, m, _), l = ut(e, i), u = ut(n, l), a = te(l, E), L()
                }
                ...
                return N.stream = function (t) {
                    ...
                    return arguments.length ? (S = t, O = void 0, L()) : S
                }, N.postclip = function (t) {
                    return arguments.length ? (x = t, M = i = r = o = null, L()) : x
                }, N.clipAngle = function (t) {
                    return arguments.length ? (S = +t ? zt(O = t * y) : (O = null, Ct), L()) : O * v
                }, N.clipExtent = function (t) {
                    return arguments.length ? (x = null == t ? (M = i = r = o = null, It) : Xt(M = +t[0][0], i = +t[0][1], r = +t[1][0], o = +t[1][1]), L()) : null == M ? null : [
                        [M, i],
                        [r, o]
                    ]
                }, N.scale = function (t) {
                    ...
                    return arguments.length ? (p = +t[0], h = +t[1], k()) : [p, h]
                }, N.center = function (t) {
                    return arguments.length ? (g = t[0] % 360 * y, d = t[1] % 360 * y, k()) : [g * v, d * v]
                }, N.rotate = function (t) {
                    return arguments.length ? (b = t[0] % 360 * y, m = t[1] % 360 * y, _ = t.length > 2 ? t[2] % 360 * y : 0, k()) : [b * v, m * v, _ * v]
                }, N.angle = function (t) {
                    return arguments.length ? (w = t % 360 * y, k()) : w * v
                }, N.reflectX = function (t) {
                    return arguments.length ? (P = t ? -1 : 1, k()) : P < 0
                }, N.reflectY = function (t) {
                    return arguments.length ? (j = t ? -1 : 1, k()) : j < 0
                }, N.precision = function (t) {
                    return arguments.length ? (a = te(l, E = t * t), L()) : D(E)
                    ...
                    function () {
                        return e = t.apply(this, arguments), N.invert = e.invert && C, k()
                    }
            }
            ...
            function ae() {
                return function (t) {
                    ...
                    return r.scale = function (t) {
                        ...
                        return arguments.length ? (null == t ? s = e = n = i = null : (s = +t[0][0], e = +t[0][1], n = +t[1][0], i = +t[1][1]), c()) : null == s ? null : [
                            [s, e],
                            [n, i]
                        ]
                    }, c()
            ...
            var le, ue, se, ce, fe = n(9395),
                pe = function (t) {
                    ...
                    return (0, i.ZT)(e, t), Object.defineProperty(e.prototype, "setupDefaultRules", {
                        ...
                        value: function () {
                            ...
                            var e, n = this._root.interfaceColors,
                ...
                ye = {
                    ...
                    polygonEnd: function () {
                        ye.lineStart = ye.lineEnd = ye.point = k, de.add(b(ve)), ve = new s
                    },
                    result: function () {
                        var t = de / 2;
                        return de = new s, t
            ...
            var Pe, je, Oe, Se, Me = ye,
                ...
                Re = {
                    ...
                    polygonEnd: function () {
                        Re.point = Ye, Re.lineStart = Xe, Re.lineEnd = Be
                    },
                    result: function () {
                        var t = ze ? [Le / ze, Te / ze] : ke ? [Ne / ke, Ce / ke] : Ee ? [xe / Ee, De / Ee] : [NaN, NaN];
                        return xe = De = Ee = Ne = Ce = ke = Le = Te = ze = 0, t
                    }
                };
            ...
            function Ge(t, e) {
                var n = t - Oe,
                    i = e - Se,
                    r = D(n * n + i * i);
                Ne += r * (Oe + t) / 2, Ce += r * (Se + e) / 2, ke += r, Ye(Oe = t, Se = e)
            }
            ...
            function Fe(t, e) {
                var n = t - Oe,
                    i = e - Se,
                    r = D(n * n + i * i);
                Ne += r * (Oe + t) / 2, Ce += r * (Se + e) / 2, ke += r, Le += (r = Se * t - Oe * e) * (Oe + t), Te += r * (Se + e), ze += 3 * r, Ye(Oe = t, Se = e)
            }
            var Ve = Re;
            ...
            function en(t, e) {
                tn.point = nn, Qe = Ue = t, qe = Ke = e
            }

            function nn(t, e) {
                Ue -= t, Ke -= e, $e.add(D(Ue * Ue + Ke * Ke)), Ue = t, Ke = e
            }
            var rn = tn;
            ...
            var ln, un, sn, cn, fn, pn, hn, gn, dn, vn, yn, bn, mn, _n, wn, Pn, jn = n(1112),
                On = n(3145),
                Sn = n(751),
                Mn = n(5040),
                xn = {
                    ...
                    lineEnd: Ln,
                    polygonStart: function () {
                        xn.lineStart = Tn, xn.lineEnd = zn
                    },
                    polygonEnd: function () {
                        xn.lineStart = Nn, xn.lineEnd = Ln
                    }
                };
            ...
            function Cn(t, e) {
                t *= y;
                var n = w(e *= y);
                _n = n * w(t), wn = n * M(t), Pn = M(e), xn.point = kn, En(_n, wn, Pn)
            }
            ...
            var Xn, In, Gn, Bn, Zn, An, Wn, Fn, Vn, Jn, Hn, Qn, qn, Un, Kn, $n, ti = new s,
                ei = new s,
                ni = {
                    point: k,
                    lineStart: k,
                    ...
                    polygonEnd: function () {
                        var t = +ti;
                        ei.add(t < 0 ? d + t : t), this.lineStart = this.lineEnd = this.point = k
                    },
                    sphere: function () {
                        ei.add(d)
                    }
            ...
            function oi(t, e) {
                ni.point = ai, Xn = t, In = e, Gn = t *= y, Bn = w(e = (e *= y) / 2 + g), Zn = M(e)
            }
            ...
            var ui = {
                ...
                lineEnd: pi,
                polygonStart: function () {
                    ui.point = hi, ui.lineStart = gi, ui.lineEnd = di, Un = new s, ni.polygonStart()
                },
                polygonEnd: function () {
                    ni.polygonEnd(), ui.point = si, ui.lineStart = fi, ui.lineEnd = pi, ti < 0 ? (An = -(Fn = 180), Wn = -(Vn = 90)) : Un > c ? Vn = 90 : Un < -c && (Wn = -90), $n[0] = An, $n[1] = Fn
                },
                sphere: function () {
                    An = -(Fn = 180), Wn = -(Vn = 90)
                }
            ...
            function pi() {
                $n[0] = An, $n[1] = Fn, ui.point = si, qn = null
            }

            function hi(t, e) {
                if (qn) {
                    var n = t - Jn;
                    Un.add(b(n) > 180 ? n + (n > 0 ? 360 : -360) : n)
                } else Hn = t, Qn = e;
                ni.point(t, e), ci(t, e)
            }
            ...
            function di() {
                hi(Hn, Qn), ni.lineEnd(), b(Un) > c && (An = -(Fn = 180)), $n[0] = An, $n[1] = Fn, qn = null
            }
                ...
                return function () {
                    ...
                    function a() {
                        var a = n.apply(this, arguments),
                            l = i.apply(this, arguments) * y,
                            u = r.apply(this, arguments) * y;
                        return t = [], e = ct(-a[0] * y, -a[1] * y, 0).invert, Lt(o, l, u, 1), a = {
                            type: "Polygon",
                            coordinates: [t]
                        }, t = e = null, a
                    }
                    return a.center = function (t) {
                        return arguments.length ? (n = "function" == typeof t ? t : kt([+t[0], +t[1]]), a) : n
                    }, a.radius = function (t) {
                        return arguments.length ? (i = "function" == typeof t ? t : kt(+t), a) : i
                    }, a.precision = function (t) {
                        return arguments.length ? (r = "function" == typeof t ? t : kt(+t), a) : r
                    }, a
            ...
            function wi(t) {
                var e = function (t) {
                    ...
                    return Kn = $n = null, An === 1 / 0 || Wn === 1 / 0 ? [
                        [NaN, NaN],
                        [NaN, NaN]
                    ] : [
                        [An, Wn],
            ...
            function ji(t) {
                var e = Oi(t.longitude),
                    n = Math.asin(Math.sin(t.latitude * Sn.RADIANS)) * Sn.DEGREES,
                    i = Oi(t.latitude);
                ...
                Mi = function (t) {
                    function e() {
                        ...
                        return Object.defineProperty(e, "_downTranslateX", {
                            ...
                            writable: !0,
                            value: 0
                        }), Object.defineProperty(e, "_centerY", {
                            enumerable: !0,
                            configurable: !0,
                            writable: !0,
                            value: 0
                    ...
                    return (0, i.ZT)(e, t), Object.defineProperty(e.prototype, "_makeGeoPath", {
                        ...
                        value: function () {
                            ...
                            "none" != e || "none" != n ? (this._wheelDp = i.events.on("wheel", (function (i) {
                                var r = t.get("wheelEasing"),
                                    o = t.get("wheelSensitivity", 1),
                                    a = t.get("wheelDuration", 0),
                                    l = i.originalEvent;
                                l.preventDefault();
                        ...
                        value: function () {
                            ...
                            if (this._dirtyGeometries && (this._geometryColection.geometries = [], this.series.each((function (t) {
                                ...
                                var g, d = n.scale();
                                this.setPrivateRaw("mapScale", d), n.scale(d * this.get("zoomLevel", 1)), this._centerLocation && (g = n(this._centerLocation)) && (c = n.translate(), f = l - (g[0] - c[0]), p = u - (g[1] - c[1]), n.translate([f, p]), this.setRaw("translateX", f), this.setRaw("translateY", p)), this.markDirtyProjection()
                            }
                            if (this._pw = i, this._ph = r, this.isDirty("zoomControl")) {
                                var v = this._prevSettings.zoomControl,
                                    y = this.get("zoomControl");
                                y !== v && (this._disposeProperty("zoomControl"), v && v.dispose(), y && (y.setPrivate("chart", this), this.children.push(y)), this.setRaw("zoomControl", y))
                            }
                            this.isDirty("zoomLevel") && (n.scale(this.getPrivate("mapScale") * this.get("zoomLevel", 1)), this.markDirtyProjection()), (this.isDirty("translateX") || this.isDirty("translateY")) && (n.translate([this.get("translateX", this.width() / 2), this.get("translateY", this.height() / 2)]), this.markDirtyProjection()), n.rotate && (this.isDirty("rotationX") || this.isDirty("rotationY") || this.isDirty("rotationZ")) && (n.rotate([this.get("rotationX", 0), this.get("rotationY", 0), this.get("rotationZ", 0)]), this.markDirtyProjection())
                        }
                        ...
                        value: function () {
                            ...
                            if (!t) {
                                var e = this.getPrivate("geoPath").bounds(this._geometryColection),
                                    n = e[0][0],
                                    i = e[0][1],
                                    r = e[1][0],
                                    o = e[1][1];
                        ...
                        value: function (t) {
                            ...
                            if (e > 0) {
                                ...
                                if (r && r.events.enableType("click"), this.get("panX") || this.get("panY")) {
                                    ...
                                    if (l.invert) {
                                        var u = l.invert([o.x, o.y]),
                                            s = l.invert([o.x + 1, o.y + 1]);
                            ...
                            if (a.each(e._downPoints, (function (e, o) {
                                ...
                                if (l && u && s && c) {
                                    ...
                                    var h = {
                                        ...
                                        d = this._downTranslateX || 0,
                                        v = this._downTranslateY || 0,
                                        y = this._downZoomLevel,
                                        b = h.x - (-d + g.x) / y * p,
                                        m = h.y - (-v + g.y) / y * p;
                        ...
                        value: function (t) {
                            ...
                            if (this.get("pinchZoom") && r && (this._movePoints[r] = t.point, a.keys(e._downPoints).length > 1)) this._handlePinch();
                            else if ((!i || !r || r == i) && n) {
                                var o = this.get("panX"),
                                    l = this.get("panY");
                                if ("none" != o || "none" != l) {
                                    var u = e._display,
                                        s = u.toLocal(t.point);
                                    n = u.toLocal(n);
                                    var c = this._downTranslateX,
                                        f = this._downTranslateY;
                                    if (Math.hypot(n.x - s.x, n.y - s.y) > 5) {
                                        var p = e.get("background");
                                        if (p && p.events.disableType("click"), Mn.isNumber(c) && Mn.isNumber(f)) {
                                            var h = this.get("projection"),
                                                g = this.get("zoomLevel", 1),
                                                d = this.get("maxPanOut", .4),
                                                v = this._mapBounds,
                                                y = this.width(),
                                                b = this.height(),
                                                m = v[1][0] - v[0][0],
                        ...
                        value: function (t, e) {
                            ...
                            var o = this.get("zoomLevel", 1),
                                a = i.x,
                                l = r.x,
                                u = i.y,
                                s = r.y,
                                c = this.seriesContainer,
                ...
                xi = function (t) {
                    ...
                    return (0, i.ZT)(e, t), Object.defineProperty(e.prototype, "_afterNew", {
                        ...
                        value: function (e) {
                            ...
                            if (n) {
                                if ("Point" == n.type) (i = n.coordinates) && (e.set("longitude", i[0]), e.set("latitude", i[1]));
                                else if ("MultiPoint" == n.type) {
                                    var i;
                        ...
                        value: function (t) {
                            ...
                            t.bullets = [], this.bullets.each((function (n) {
                                var i = t.get("geometry");
                                if (i)
                                    if ("Point" == i.type) e._makeBullet(t, n);
                        ...
                        value: function (t) {
                            ...
                            if (e) {
                                var n, i = e.dataItem,
                                    r = i.get("latitude"),
                                    o = i.get("longitude"),
                                    a = i.get("lineDataItem"),
                                    l = this.chart;
                                if (a) n = a.get("mapLine");
                                else {
                                    var u = i.get("lineId");
                                ...
                                var p = i.get("positionOnLine"),
                                    h = void 0,
                                    g = void 0;
                                if (s) h = [(d = s.visualCentroid()).longitude, d.latitude];
                                else if (n && Mn.isNumber(p)) {
                                    var d;
                                    if (h = [(d = n.positionToGeoPoint(p)).longitude, d.latitude], i.get("autoRotate", t.get("autoRotate")) && l) {
                                        var v = n.positionToGeoPoint(p - .002),
                                            y = n.positionToGeoPoint(p + .002),
                                            b = l.convert(v),
                                            m = l.convert(y);
                                        g = Sn.getAngle(b, m)
                                    }
                                } else if (Mn.isNumber(o) && Mn.isNumber(r)) h = [o, r];
                                else {
                                    var _ = i.get("geometry");
                                    if (_)
                                        if ("Point" == _.type) this._positionBulletReal(t, _, _.coordinates, g);
                                        else if ("MultiPoint" == _.type) {
                                            var w = t._index || 0;
                                            h = _.coordinates[w]
                                        }
                                }
                                h && this._positionBulletReal(t, {
                                    type: "Point",
                                    coordinates: h
                                }, h, g)
                            }
                        ...
                        value: function (t, e, n, i) {
                            var r = t.get("sprite"),
                                o = this.chart;
                            if (o) {
                                var a = o.get("projection"),
                                    l = o.getPrivate("geoPath"),
                                    u = r.dataItem,
                                    s = a(n);
                                s && r.setAll({
                                    x: s[0],
                    ...
                    return (0, i.ZT)(e, t), Object.defineProperty(e.prototype, "_beforeChanged", {
                        ...
                        value: function () {
                            ...
                            if (n) {
                                if ("Polygon" == n.type) e = n.coordinates;
                                    ...
                                    for (var i = 0; i < n.coordinates.length; i++) {
                                        var r = n.coordinates[i],
                                            o = li({
                                                type: "Polygon",
                                                coordinates: r
                                            });
                        ...
                        value: function () {
                            ...
                            if (t) {
                                var e = t.projection();
                                if (e) {
                                    var n = this.visualCentroid(),
                                        i = e([n.longitude, n.latitude]);
                                    if (i) return {
                                        x: i[0],
                                        y: i[1]
                                    }
                ...
                zi = function (t) {
                    function e() {
                        ...
                        return Object.defineProperty(e, "plusButton", {
                            ...
                            configurable: !0,
                            writable: !0,
                            value: e.children.push(Li.z.new(e._root, {
                                width: 36,
                                height: 36,
                                themeTags: ["plus"]
                            }))
                    ...
                    return (0, i.ZT)(e, t), Object.defineProperty(e.prototype, "_afterNew", {
                        ...
                        value: function () {
                            if (t.prototype._prepareChildren.call(this), this.isPrivateDirty("chart")) {
                                var e = this.getPrivate("chart"),
                                    n = this._prevPrivateSettings.chart;
                                e && (this._disposer = new Ti.FV([this.plusButton.events.on("click", (function () {
                                    e.zoomIn()
                        ...
                        configurable: !0,
                        writable: !0,
                        value: ki.W.classNames.concat([e.className])
                    }), e
                }(ki.W);
            ...
            function Bi() {
                ...
                }(Gi).scale(155.424).center([0, 33.6442])
            }

            function Zi() {
                var t, e, n, i, r, o, a = Bi().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-.6, 38.7]),
                    l = Bi().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
                    u = Bi().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
                    s = {
                        point: function (t, e) {
                            o = [t, e]
                        }
                ...
                return f.invert = function (t) {
                    ...
                    return n = a.translate(t).clipExtent([
                        [o - .455 * e, f - .238 * e],
                        [o + .455 * e, f + .238 * e]
                    ]).stream(s), i = l.translate([o - .307 * e, f + .201 * e]).clipExtent([
                        [o - .425 * e + c, f + .12 * e + c],
                        [o - .214 * e - c, f + .234 * e - c]
                    ]).stream(s), r = u.translate([o - .205 * e, f + .212 * e]).clipExtent([
                        [o - .214 * e + c, f + .166 * e + c],
                        [o - .115 * e - c, f + .234 * e - c]
                    ]).stream(s), p()
        ...
        5417: function (t, e, n) {
            ...
            function r(t, e, n) {
                ...
                for (var y = new i(void 0, o), b = r; b < u; b += g)
                    for (var m = l; m < s; m += g) y.push(new a(b + d, m + d, d, t));
                var _ = function (t) {
            ...
            function a(t, e, n, i) {
                this.x = t, this.y = e, this.h = n, this.d = function (t, e, n) {
                    for (var i = !1, r = 1 / 0, o = 0; o < n.length; o++)
                        for (var a = n[o], u = 0, s = a.length, c = s - 1; u < s; c = u++) {
                            var f = a[u],
                                p = a[c];
